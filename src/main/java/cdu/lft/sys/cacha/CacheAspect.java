...
public class CacheAspect {
    ...
    * */
    ...
    //声明切面表达式
    private static final String POINTCUT_DEPT_UPDATE="execution(* cdu.lft.sys.service.impl.DeptServiceImpl.updateById(..))";
    private static final String POINTCUT_DEPT_GETBYID="execution(* cdu.lft.sys.service.impl.DeptServiceImpl.getById(..))";
    private static final String POINTCUT_DEPT_REMOVE="execution(* cdu.lft.sys.service.impl.DeptServiceImpl.removeById(..))";
    private static final String POINTCUT_DEPT_SAVE="execution(* cdu.lft.sys.service.impl.DeptServiceImpl.save(..))";


    private static final String POINTCUT_USER_UPDATE="execution(* cdu.lft.sys.service.impl.UserServiceImpl.updateById(..))";
    private static final String POINTCUT_USER_GETBYID="execution(* cdu.lft.sys.service.impl.UserServiceImpl.getById(..))";
    private static final String POINTCUT_USER_REMOVE="execution(* cdu.lft.sys.service.impl.UserServiceImpl.removeById(..))";
    private static final String POINTCUT_USER_SAVE="execution(* cdu.lft.sys.service.impl.UserServiceImpl.save(..))";
